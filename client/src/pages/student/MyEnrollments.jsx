...
const MyEnrollements = () => {
  ...
  const [progressArray, setProgressArray] = useState([
    ...
    { lectureCompleted: 11, totalLectures: 23 },
    { lectureCompleted: 2, totalLectures: 13 },
    { lectureCompleted: 4, totalLectures: 13 },
    { lectureCompleted: 12, totalLectures: 23 },
    { lectureCompleted: 8, totalLectures: 12 },
    { lectureCompleted: 10, totalLectures: 13 },
    { lectureCompleted: 5, totalLectures: 19 },
    { lectureCompleted: 1, totalLectures: 3 },
  ]);

  return (
    <>
      <div className="md:ppx-36 px-8 pt-10">
        <h1 className="text-2xl font-semibold">MyEnrollements</h1>
